...
class CategoryState {
  ...
  factory CategoryState.loading({List<CategoryModel>? currentCategories}) {
    return CategoryState(isLoading: true, categories: currentCategories ?? []);
  }
  ...
  factory CategoryState.error(String message, List<CategoryModel> categories) {
    return CategoryState(
      isLoading: false,
      error: message,
      categories: categories,
